...
<body class="bg-slate-50 text-slate-800 antialiased">
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="hidden lg:flex w-64 flex-col border-r border-slate-200 bg-white">
            ...
            <div class="px-3 pb-2">
                <a href="{{ route('operator.setting.team') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-600 text-sm hover:bg-slate-50">
            ...
            <main class="flex-1 p-4 sm:p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        {{-- Add accountant --}}
                        <a href="#" class="flex items-center justify-center gap-2 w-full px-4 py-3 rounded-xl bg-indigo-600 text-white font-semibold hover:bg-indigo-700 transition">
