...
<body class="bg-slate-50 text-slate-800 antialiased">
    ...
    @php
        $user = [
            ...
            'last_name'  => 'Vint',
            'email'      => 'vintalexandru03@gmail.com',
            'role'       => 'Operator',
        ];
    @endphp
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="hidden lg:flex w-64 flex-col border-r border-slate-200 bg-white">
            ...
            <div class="px-3 pb-2">
                <a href="{{ route('administrator.settings.profile') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg bg-indigo-50 text-indigo-700 font-medium text-sm">
