            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <div class="lg:col-span-3 space-y-6">
                    ...
                    <div class="ui-card overflow-hidden">
                        ...
                        <form action="{{ route('administrator.profile.update') }}" method="POST"
                            ...
                            <div class="flex items-center gap-4">
                                <div
                                    class="grid place-items-center w-16 h-16 rounded-full bg-slate-200 text-slate-600 dark:text-slate-300 font-semibold text-lg shrink-0">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label for="first_name"
                                        class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Prenume</label>
                                    <input type="text" id="first_name" name="first_name" required maxlength="255"
                                        value="{{ old('first_name', $user->first_name) }}" class="form-input">
                                    @error('first_name')
                                ...
                                <div>
                                    <label for="last_name"
                                        class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Nume</label>
                                    <input type="text" id="last_name" name="last_name" required maxlength="255"
                                        value="{{ old('last_name', $user->last_name) }}" class="form-input">
                                    @error('last_name')
                                        <p class="text-xs text-rose-600 mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-slate-400">Emailul e și numele tău de utilizator la
                                    autentificare.</p>
                                @error('email')
                                    <p class="text-xs text-rose-600 mt-1">{{ $message }}</p>
                                @enderror
                    ...
                    <div class="ui-card overflow-hidden">
                        ...
                        <form action="{{ route('administrator.profile.password') }}" method="POST"
                            ...
                            <div>
                                <label for="current_password"
                                    class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Parola
                                    actuală</label>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label for="password_confirmation"
                                        class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Confirmă
                                        parola nouă</label>
