    ...
    <div class="flex min-h-screen">
        ...
        <aside class="hidden lg:flex w-64 flex-col border-r border-slate-200 bg-white">
            ...
            <nav class="flex-1 px-3 py-4 space-y-1 text-sm">
                ...
                <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-600 hover:bg-slate-50">
                    <svg class="w-4 h-4 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-6h6v6m-9 4h12a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                    Rapoarte
                </a>
                <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-600 hover:bg-slate-50">
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <header class="flex items-center gap-4 h-16 px-4 sm:px-6 border-b border-slate-200 bg-white">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <span class="hidden sm:inline text-xs px-2 py-1 rounded-full bg-slate-100 text-slate-600 font-medium">Doar vizualizare</span>
                </div>
            </header>
            ...
            <main class="flex-1 p-4 sm:p-6 space-y-6">
                ...
                <div>
                    ...
                    <p class="text-slate-500 text-sm mt-1">Situația firmei {{ $company->name }}:</p>
                </div>
                        ...
                        <div class="bg-white rounded-xl border border-slate-200 p-5">
                            <div class="flex items-start justify-between">
                                <div>
                                    ...
                                    <p class="text-sm text-slate-500 mt-1">Total facturat, plătit, sold de încasat și istoric per client.</p>
                                </div>
                                <svg class="w-8 h-8 text-indigo-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                            </div>

                            <form action="#" method="GET" class="mt-4 space-y-3">
                                <label class="block">
                                    <span class="text-xs font-medium text-slate-500">Client</span>
                                    <select name="client_id" class="mt-1 w-full rounded-lg border border-slate-200 text-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                ...
                                <div class="flex items-center gap-2 pt-1">
                                    <button type="submit" name="format" value="pdf" class="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 rounded-lg border border-slate-200 text-sm font-medium text-slate-700 hover:bg-slate-50 transition">
                                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v12m0 0l-4-4m4 4l4-4M4 20h16"/></svg>
                                        PDF
                                    </button>
                                    <button type="submit" name="format" value="xlsx" class="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 rounded-lg border border-slate-200 text-sm font-medium text-slate-700 hover:bg-slate-50 transition">
                                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v12m0 0l-4-4m4 4l4-4M4 20h16"/></svg>
                                        Excel
                                    </button>
                                </div>
                        ...
                        <div class="bg-white rounded-xl border border-slate-200 p-5">
                            <div class="flex items-start justify-between">
                                <div>
                                    ...
                                    <p class="text-sm text-slate-500 mt-1">Încasări lunare, sume rămase de încasat și defalcare pe cote de TVA.</p>
                                </div>
                                <svg class="w-8 h-8 text-indigo-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                            </div>

                            <form action="#" method="GET" class="mt-4 space-y-3">
                                <label class="block">
                                    <span class="text-xs font-medium text-slate-500">Luna</span>
                                    <input type="month" name="month" class="mt-1 w-full rounded-lg border border-slate-200 text-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                </label>
                    ...
                    <div class="xl:col-span-2 space-y-4">
                        <div class="bg-white rounded-xl border border-slate-200">
                            <div class="px-5 py-4 border-b border-slate-200 flex items-center justify-between">
                                ...
                                <label class="relative">
                                    <select class="appearance-none pl-3 pr-8 py-1.5 rounded-lg border border-slate-200 bg-slate-50 text-xs font-medium focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                    ...
                                    <svg class="w-3.5 h-3.5 absolute right-2.5 top-1/2 -translate-y-1/2 pointer-events-none text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                                </label>
                            </div>
                                        ...
                                        @foreach ($facturi as $f)
                                            <tr class="hover:bg-slate-50">
                                                ...
                                                <td class="px-5 py-3 text-right">
                                                    <a href="#" class="text-indigo-600 hover:underline text-sm">Vezi</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                    ...
                    <div class="space-y-4">
                        <div class="bg-white rounded-xl border border-slate-200">
                            ...
                            <ul class="divide-y divide-slate-100 text-sm">
                                @php
                                    $audit = [
                                        ['user' => 'M. Ionescu', 'action' => 'a emis factura F-0142', 'time' => 'azi, 10:24'],
                                        ['user' => 'A. Radu',    'action' => 'a înregistrat o plată pe F-0140', 'time' => 'azi, 09:10'],
                                        ['user' => 'M. Ionescu', 'action' => 'a stornat factura F-0135', 'time' => 'ieri, 17:42'],
                                    ];
                                @endphp
                                @foreach ($audit as $entry)
                                    <li class="px-5 py-3">
                                        <p class="text-slate-800"><span class="font-medium">{{ $entry['user'] }}</span> {{ $entry['action'] }}</p>
                                        <p class="text-xs text-slate-400 mt-0.5">{{ $entry['time'] }}</p>
                                    </li>
                                @endforeach
                            </ul>
                            <div class="px-5 py-4 border-t border-slate-200">
                                <a href="#" class="text-sm text-indigo-600 hover:underline">Vezi jurnalul complet</a>
                            </div>
                        </div>
                    </div>
                </div>
