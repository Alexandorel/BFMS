        ...
        <div class="flex-1 flex flex-col min-w-0">
            <main class="flex-1 p-4 sm:p-6">
                <div class="max-w-lg mx-auto">
                    <h1 class="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-6">Editeaza Client</h1>
                    <form method="POST" action="{{ route('clients.update', $client) }}" class="bg-white rounded-xl border border-slate-200 p-6 space-y-4">
                        @csrf
                        @method('PUT')
